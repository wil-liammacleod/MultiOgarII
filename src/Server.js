...
class Server {
    ...
    mainLoop() {
        ...
        if (this.ticks > this.config.serverRestart && this.run) {
            Logger.info(`this.ticks > this.config.serverRestart && this.run`);
            Logger.info(`this.config.serverRestart ${this.config.serverRestart}`);
            this.restart();
        }
        // Loop main functions
        if (this.run) {
